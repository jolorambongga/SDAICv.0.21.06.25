...
CREATE TABLE IF NOT EXISTS tbl_ServiceSched (
    service_sched_id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS tbl_DoctorSched (
    doctor_sched_id INT AUTO_INCREMENT PRIMARY KEY,
